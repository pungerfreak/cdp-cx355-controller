 ...
 * Size: 18 px
 * Bpp: 4
 * Opts: --bpp 4 --size 18 --no-compress --stride 1 --align 1 --font OpenSans-Regular.ttf --range 65-90,97,48-57 --format lvgl -o open_sans_18.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_cmap_t open_sans_18_cmaps[] =
{
    ...
    {
        .range_start = 97, .range_length = 1, .glyph_id_start = 37,
        .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY
    }
};
